...
const countries = [
    ...
    select_box = document.querySelector('.country-options'),
    search_box = document.querySelector('.search-box'),
    input_box = document.querySelector('.phone-input'),
    selected_option = document.querySelector('.selected-country'),
    country_selector = document.querySelector('.country-selector');
...
function selectOption() {
    ...
    const icon = this.querySelector('.iconify').cloneNode(true),
        phone_code = this.querySelector('strong').innerText,
        dropdown_arrow = document.createElement('span');
    
    dropdown_arrow.className = 'dropdown-arrow';
    dropdown_arrow.textContent = '▼';

    selected_option.innerHTML = '';
    selected_option.append(icon, dropdown_arrow);

    input_box.value = phone_code + ' ';

    country_selector.classList.remove('active');
...
selected_option.addEventListener('click', () => {
    country_selector.classList.toggle('active');
